...
const CityGuide = () => {
    ...
    function OpenPortalKadry(){
        let OpenTabNum = localStorage.getItem("userTabelNum")
        if(OpenTabNum == 55654 ||OpenTabNum == 39530 || OpenTabNum == 55740 || OpenTabNum == 50363 ){
            ...
            return (
                <NavLink  to="/cityGuide" title="кадры">
                    <li>
