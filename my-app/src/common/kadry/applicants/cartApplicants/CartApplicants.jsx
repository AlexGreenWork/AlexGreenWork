...
const CartApplicants = (props) => {
                        ...
                        <div className={st.leftCol}>
                            ...
                            <div style={{
                                ...
                                <div style={{display: "flex", flexDirection: "column"}} className="about">
                                    ...
                                    <object data={'http://localhost:5000/kadryq/1.jpg#toolbar=0&amp;navpanes=0&amp;scrollbar=0&amp;page=1&amp;view=FitH'} type="application/pdf" width="100%" height="500px" ></object>
                                    {/* <Test/> */}
                                    {/* <Sample/> */}
                                </div>
    ...
    return (
// <NavLink to="/kadry_/applicants/CartApplicant" style={{ width:"100%"}} >
        <div style={{width: "100%"}}>
            <OpenCart isOpen={false} req={props}/>
            <div onClick={openCartState} className={s.cart}
                 style={{display: "flex", width: "100%", border: "1px solid #8282f7", minHeight: "70px"}}>
                <div className={s.rowCart}
                     style={{display: "flex", width: "20%", color: 'blue', fontWeight: "bold"}}>{props.fio}</div>
