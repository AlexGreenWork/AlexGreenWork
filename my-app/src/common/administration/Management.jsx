...
import ConclusionCard from "../offers/cardOffer/offersProperties/conclusion/conclusionCard";


class Administration extends React.Component {
    constructor(props) {
        super(props);
        this.readAdministration()
        this.state = {list: []}
    }
                                    ...
                                    {this.state.list.map(( item, i ) => (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div style={{
                                                    backgroundImage: `url(${
                                                        API_URL + "files/photos/" + item.TABNUM + ".jpg"
                                                    })`,
                                                ...
                                                <span>{item.NAME}</span>
                                                <span style={{color: "black"}}>{item.PROFNAME}</span>
